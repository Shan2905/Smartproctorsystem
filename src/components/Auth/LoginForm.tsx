    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">ProctorAI</h2>
          <p className="mt-2 text-sm text-gray-600">Smart Proctoring for DSA & C++</p>
        </div>
          ...
          <div className="text-sm text-gray-600">
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <div className="text-xs space-y-1">
                <p><strong>Admin:</strong> admin@proctoring.com</p>
                <p><strong>Proctor:</strong> proctor@proctoring.com</p>
                <p><strong>Student:</strong> student@proctoring.com</p>
